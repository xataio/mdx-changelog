...
- **[*FIX*]** **Default value update for column additions**: Default value auto-quoting for new columns has been removed to fix issues with time-based defaults like `now()`. Users now need to manually quote necessary default values. [PR #200](https://github.com/xataio/pgroll/pull/200)
