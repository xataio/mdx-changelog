...
- In preparation for our launch week (shhh! it's coming soon) we have re-structured our docs to make it easier to find what you're looking for. Please let us know if you have any feedback! Also quick reminder: the search bar in the docs works really well (because it's basd on Xata).
- We've also added "beta" and "alpha" tags to features that are not yet generally available. We define "alpha" as "available to a select group of users" and "beta" as "available to all customers, but not yet stable".
