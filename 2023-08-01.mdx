...
- CSV Import CLI improvements: CSV Import via the CLI is now ~2.5x faster and infers column types better.
...
![Search total count](https://github.com/xataio/mdx-changelog/raw/main/images/search-total-count.png)
