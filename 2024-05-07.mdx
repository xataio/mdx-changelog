...
- [#46](https://github.com/xataio/pgzx/pull/46) Several improvements to the `pgzx.mem` module, including fixes and tests.
- [#47](https://github.com/xataio/pgzx/pull/47) Updated the Zig toolchain and the docker images.
